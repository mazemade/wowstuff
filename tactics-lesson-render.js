(function (root, factory) {
    ...
    function layout(ctx, width, height, lesson) {
        ...
        const footerHeight = lesson.compact && (lesson.recap || !rows.length) && !warningLines.length ? 0 : Math.max(54, warningLines.length ? 55 + roleHeight + Math.max(0, warningLines.length - 1) * 17 : 18 + roleHeight);
