...
assert.deepEqual(Object.keys(D.FIGHTS).filter(id => id.startsWith('bt-')), ['bt-najentus', 'bt-supremus', 'bt-akama', 'bt-reliquary', 'bt-bloodboil', 'bt-mother', 'bt-council', 'bt-illidan'], 'Black Temple encounter registration remains intact');
